...
if ($tmp_show_user_images) {
    try {
        ...
        if ($req->rowCount() == 0) {
            echo '<script type="text/javascript">document.getElementById("user-nb-pics-top").innerHTML = "0";</script>';
            echo '<script type="text/javascript">document.getElementById("user-nb-pics").innerHTML = "0";</script>';
            echo '<p class="bg-danger text-center">No images found for this user</p>';
        }
        else {
            echo '<script type="text/javascript">document.getElementById("user-nb-pics-top").innerHTML = "'.$req->rowCount().'";</script>';
            echo '<script type="text/javascript">document.getElementById("user-nb-pics").innerHTML = "'.$req->rowCount().'";</script>';
